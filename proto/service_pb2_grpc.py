...
class PerceptionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendObservation = channel.unary_unary(
                '/cleo.PerceptionService/SendObservation',
                request_serializer=service__pb2.Observation.SerializeToString,
...
class PerceptionServiceServicer(object):
    ...
    def SendObservation(self, request, context):
        """Recebe dados brutos do cliente (evento simplificado)
        """
...
def add_PerceptionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendObservation': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=service__pb2.Observation.FromString,
                    response_serializer=service__pb2.Ack.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'cleo.PerceptionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cleo.PerceptionService', rpc_method_handlers)
...
class PerceptionService(object):
    ...
    def SendObservation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cleo.PerceptionService/SendObservation',
            service__pb2.Observation.SerializeToString,
